...
class ContaIterador:
    ...
    def __next__(self):
        try:
            ...
            Número:\t\t{conta.numero}
            Titular:\ttttttttt{conta.cliente.nome}
...
class Conta:
    ...
    def sacar(self, valor):
        ...
        excedeu_disponivel = valor > saldo_disponivel
...
def filtrar_clinte(cpf, clientes):
    clintes_filtrados = [cliente for cliente in clientes if cliente.cpf == cpf]
    return clintes_filtrados[0] if clintes_filtrados else None
...
def depositar(clientes):
    ...
    cliente = filtrar_clinte(cpf, clientes)
